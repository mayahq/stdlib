...
export { FProgram, LocalStorage, Runtime } from 'https://deno.land/x/mayalabs_runtime/mod.ts'
export type { FunctionalProgramDsl, FunctionalSymbolDsl } from 'https://deno.land/x/mayalabs_runtime/mod.ts'
